...
\begin{definition}
  ...
  \begin{definition} \label{de:arp}
    ...
    Некоторые авторы, например, замечательный Аад ван дер Ваарт \cite{vaart:ts}, 
...
\section{Скользящее среднее}
  ...
  \chapter{Тесты на прогнозную силу}
