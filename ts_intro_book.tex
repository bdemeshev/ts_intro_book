...
\ifx\ifxetex\ifluatex\else % если xelatex или lualatex
  ...
  \renewcommand{\allcapsspacing}[1]{\textls[15]\label{1}}
  \renewcommand{\smallcapsspacing}[1]{\textls[10]\label{1}}
  \renewcommand{\allcaps}[1]{\textls[15]{\MakeTextUppercase\label{1}}}
  \renewcommand{\smallcaps}[1]{\smallcapsspacing{\scshape\MakeTextLowercase\label{1}}}
  \renewcommand{\textsc}[1]{\smallcapsspacing{\textsmallcaps\label{1}}}
\fi
...
\subsection{Тест Диболда-Мариано}
...
\renewenvironment{solution}[1]{%
         ...
         {\bfseries \hyperlink{problem:#1}\label{1.}}%
}%
{%
}%
